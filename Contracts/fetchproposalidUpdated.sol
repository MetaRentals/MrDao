...
contract ProposalId is ChainlinkClient {
  ...
  uint256 public  totalAmountOfLink;
  ...
  function iToHex(bytes memory buffer) public pure returns (string memory) {
    ...
    function returnProposalId() view public returns(string) { 
      return proposalId;
    }
    //function returns balanceo Link
    function returnLinkBalance(address _address) view public returns(uint) { 
